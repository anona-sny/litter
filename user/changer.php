...
<main>
    ...
    <div id="leets-array">
        ...
        for($i = 0; $i<count($posts);$i++){
            ...
            echo '<article-footer><div class="delete-button" post-id="'.$posts[$i]->id.'" onclick="deleteTweet(this)"></div><div class="share-button"></div><div class="like-button"></div></article-footer>';
            echo '</article>';
        }
        ?>
    </div>
